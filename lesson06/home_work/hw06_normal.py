...
if __name__ == '__main__':
    teachers = [Teacher('Глеб', 'Глебович', 'Глебов', 'Химия'),
                Teacher('Влад', 'Владович', 'Владов', 'Биология'),
                Teacher('Валя', 'Валинтинович', 'Валентинов', 'География'),
                Teacher('Николай', 'Николаевич', 'Николаев', 'Физика'),
                Teacher('Василий', 'Васильевич', 'Васин', 'История')]
    classes = [Class_rooms('10 А', [teachers[0], teachers[1], teachers[2]]),
               Class_rooms('7 Б', [teachers[1], teachers[3], teachers[4]]),
               Class_rooms('9 А', [teachers[3], teachers[1], teachers[0]])]
    parents = [People('Никита', 'Никитич', 'Никитин'),
               ...
               People('Юлия', 'Сергеевна', 'Сергеева')]
    students = [Student('Влад', 'Васильевич', 'Васин', parents[0], parents[1], classes[0]),
